...
/* Table schema:
CREATE TABLE kv_store_12535d4a (
  key TEXT NOT NULL PRIMARY KEY,
  value JSONB NOT NULL
);
*/

// View at https://supabase.com/dashboard/project/foibpwuqcjtasarqwamx/database/tables
...
export const set = async (key: string, value: any): Promise<void> => {
  ...
  const { error } = await supabase.from("kv_store_12535d4a").upsert({
    key,
    value
  });
  if (error) {
