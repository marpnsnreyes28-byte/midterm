// This file is a Deno/Supabase Edge Function. It uses Deno runtime globals
// and `npm:` specifiers which are unavailable to the local TypeScript
// language service. Suppress TS checks for this file so the editor won't
// report false positives while keeping the file runnable in Supabase.
// @ts-nocheck
  ...
  try {
    ...
    const createTablesSQL = `
      ...
      CREATE TRIGGER update_attendance_records_updated_at 
        ...
        FOR EACH ROW EXECUTE FUNCTION update_updated_at_record_column();
...
app.post("/make-server-12535d4a/rfid/tap-in", async (c: any) => {
  try {
...
app.post("/make-server-12535d4a/rfid/tap-out", async (c: any) => {
  try {
